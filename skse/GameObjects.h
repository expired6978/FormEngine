...
public:
	...
	void SetRestrictions(BGSListForm * formList)
	{
		data.restrictions = static_cast<BGSListForm *>(formList);
	}
	BGSListForm * GetRestrictions()
	{
		return static_cast<BGSListForm *>(data.restrictions);
	}
};
...
public:
	...
	void *	menuOpenCloseEvent;	// 0DC - MenuOpenCloseEvent
